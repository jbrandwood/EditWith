...
var strExe = WshShell.ExpandEnvironmentStrings(
	"%ProgramFiles%\\Sublime Text 2\\sublime_text.exe" );
...
if ( Is64BitOS() )
{
	...
	if ( !objFSO.FileExists( strExe ) )
	{
		strExe = WshShell.ExpandEnvironmentStrings(
			"%ProgramFiles(x86)%\\Sublime Text 2\\sublime_text.exe" );
	}
}

MyWriteKey(
	"HKCU\\SOFTWARE\\Classes\\*\\shell\\Open with Sublime Text 2\\",
  "" );
MyWriteKey(
	"HKCU\\SOFTWARE\\Classes\\*\\shell\\Open with Sublime Text 2\\command\\",
  '\"' + strExe + '\" \"%1\"'
 );
