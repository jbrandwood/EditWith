...
int SelectMyIcon ( int iWantSz, bool &fCenterIcon, bool &fHQBScaling )
{
  ...
  if ( iWantSz < 17 ) { return IDB_MENU_BITMAP_15; }
  else
  if ( iWantSz < 21 ) { return IDB_MENU_BITMAP_17; }
  else
  if ( iWantSz < 27 ) { return IDB_MENU_BITMAP_21; }

  return IDB_MENU_BITMAP_27;
}

//
// ****************************************************************************
//
// Title string format is ... "Zeus - [C:\autoexec.bat]"
