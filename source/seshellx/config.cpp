...
int SelectMyIcon ( int iWantSz, bool &fCenterIcon, bool &fHQBScaling )
{
  ...
  if ( iWantSz < 19 ) { return IDB_MENU_BITMAP_16; }
  if ( iWantSz < 26 ) { return IDB_MENU_BITMAP_22; }

  return IDB_MENU_BITMAP_30;
}

//
// ****************************************************************************
//
// Title string format is ... "autoexec.bat - C:\autoexec.bat - SlickEdit"
  ...
  wchar_t * pString, wchar_t * &pHead, wchar_t * &pFile, wchar_t * &pTail )
{
  ...
  if ( pHead )
  {
    ...
    if ( NULL == pTail || wcsncmp( pTail--, L"- SlickEdit", 11 ) != 0 )
    {
