...
int SelectMyIcon ( int iWantSz, bool &fCenterIcon, bool &fHQBScaling )
{
  ...
  // Skip the 16-pixel UEStudio icon, the 24-pixel one looks nicer.
  if ( iWantSz < 20 ) { return IDB_MENU_BITMAP_24; }

  fHQBScaling = false;

  if ( iWantSz < 27 ) { return IDB_MENU_BITMAP_24; }
...
// ****************************************************************************
//
// Title string format is ... "[C:\autoexec.bat] - UEStudio '14"
