...
int SelectMyIcon ( int iWantSz, bool &fCenterIcon, bool &fHQBScaling )
{
  ...
  // PN2's smaller icons are all scaled from the large 48x48 icon,
  // so we may as well do the same thing here and avoid artifacts.
  return IDB_MENU_BITMAP_47;
}

//
// ****************************************************************************
//
// Title string format is ... "Programmer's Notepad - [autoexec.bat]"
